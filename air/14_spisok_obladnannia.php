...
if (
    ...
    $query = " 
    select laboratory_title, tests.assemble_id, production_category, production_title, equipment
    from aviator.tests
      ...
      left join test_equipment te on tests.test_id = te.test_id
    
    where  tests.timestamp between '$time_from' and '$time_to' ".$cond. " order by tests.assemble_id";


    $columns = array('laboratory_title',  'assemble_id', 'production_category', 'production_title', 'equipment');
    $result = mysqli_query($link, $query) or die("Ошибка " . mysqli_error($link));
    $labl = 'used equipment is:';
